    ...
    private func detect(image: UIImage, completion: @escaping (Quadrilateral?) -> Void) {
        ...
        if #available(iOS 11.0, *) {
            ...
            VisionRectangleDetector.rectangle(forImage: ciImage, orientation: orientation) { quad in
                ...
                print("[detectedQuad]:")
                print("topLeft: \(detectedQuad?.topLeft)")
                print("topRight: \(detectedQuad?.topRight)")
                print("bottomLeft: \(detectedQuad?.bottomLeft)")
                print("bottomRight: \(detectedQuad?.bottomRight)")
